...
#BWOP should most likely stay 32
set BWOP 32 
#--- numebr of apx bits
set NAB 16    
...
elaborate $my_toplevel -parameters 32,$NAB
...
report_timing -path full -sort_by slack -nworst 1000000 -max_paths 1000000 >  ${REPORTS_DIR}/${DESIGN_NAME}_${NAB}_timing.rpt
...
report_constraint -all_violators > ${REPORTS_DIR}/${DESIGN_NAME}_${NAB}_constrain_violators.rpt
