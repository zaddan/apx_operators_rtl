...
#set NAB 0    
#BWOP determines the number of bits in the accurate adder
set BWOP 16 
#
...
#--- read the design 
analyze -format verilog [list unconfig_int_add.v acc_int_add.v]
elaborate $my_toplevel -parameters $BWOP
...
report_timing -path full -sort_by slack -nworst 1000000 -max_paths 1000000 >  ${REPORTS_DIR}/${DESIGN_NAME}_${BWOP}Bit_timing.rpt
...
report_area -hierarchy -nosplit > ${REPORTS_DIR}/${DESIGN_NAME}_${BWOP}Bit_area.rpt
report_power > ${REPORTS_DIR}/${DESIGN_NAME}_${BWOP}Bit_power.rpt
report_constraint -all_violators > ${REPORTS_DIR}/${DESIGN_NAME}_${BWOP}Bit_constrain_violators.rpt
...
write -format ddc -hierarchy -output ${RESULTS_DIR}/${DESIGN_NAME}_synthesized.ddc 
#the following generates the gatelevel netlist 
write -f verilog -hierarchy -output ${RESULTS_DIR}/${DESIGN_NAME}_synthesized.v
write_sdc ${RESULTS_DIR}/${DESIGN_NAME}_synthesized.sdc
