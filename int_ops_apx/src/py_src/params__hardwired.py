...
clk_period = .49#.250;
DATA_PATH_BITWIDTH = 24#8
#-----  -----    -----     -----     -----     -----
acc_max_delay__upper_limit__initial_value = 1.52#.180#.300#.156
acc_max_delay__lower_limit__initial_value = 1.#.063#.050#.050#.152
...
precisions__curious_about__l = [16]
